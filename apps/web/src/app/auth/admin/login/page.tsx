...
export default function AdminLoginPage() {
    ...
    return (
        <AuthShell
            role="admin"
            title="Admin sign in"
            subtitle="Access universities, vendors, and platform analytics."
            footer={
        ...
        >
            ...
            <form onSubmit={handleSubmit(onSubmit)} method="post">
                <fieldset disabled={isLoading || !isReady} aria-busy={!isReady} className="m-0 w-full min-w-0 border-0 p-0 space-y-5">
                    <div>
                    ...
                    <Button type="submit" className="w-full rounded-full h-11 font-semibold" disabled={isLoading || !isReady}>
