...
function Complete() {
    ...
    const complete = async () => {
        ...
        const returnedAttempt = new URLSearchParams(window.location.search).get('attempt');
        if (!attempt || !session.browserSessionId || attempt.browserSessionId !== session.browserSessionId || returnedAttempt !== attempt.attemptId || !isCurrentSession(session)) {
