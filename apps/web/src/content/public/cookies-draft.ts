...
export const cookiesDraft: readonly LegalDraftSection[] = [
  ...
  { id: 'essential', heading: 'Account and sign-in storage', paragraphs: [
    ...
    'The homepage stores a first-visit preference in local storage so a returning browser skips the introductory splash screen. It persists until you clear site storage; clearing it only shows the introduction again.',
  ] },
