...
export const privacyDraft: readonly LegalDraftSection[] = [
  ...
  { id: 'retention', heading: 'How long information is kept', paragraphs: [
    ...
    'Account and linked identity records support access and account integrity while needed for those purposes; closure should trigger a review of continued retention rather than automatic indefinite storage. The registered Terms of Service acceptance (age declaration, version and time) is kept as the record of the agreement under which the account was provided, and may be retained after closure where needed to establish, exercise or defend a legal claim.',
