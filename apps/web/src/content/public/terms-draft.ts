...
export const termsDraft: readonly LegalDraftSection[] = [
  { id: 'operator', heading: 'Who provides Awoof and when these terms apply', paragraphs: [
    ...
    'The effective version must be presented when you register or otherwise accept the service agreement. This review draft does not itself create an agreement. The Privacy Notice explains information use; a request for consent, where needed, is a separate choice.',
  ] },
  ...
  { id: 'payments', heading: 'Payments, cancellations and refunds', paragraphs: [
    ...
    'A dispute should include the order or payment reference and a description of what happened. Contact the merchant for its fulfilment obligations and support@awoof.tech for Awoof’s involvement. You retain access to lawful bank, payment-provider, regulator and court remedies.',
  ] },
  ...
  { id: 'liability', heading: 'Our responsibility and limits on liability', paragraphs: [
    ...
    'Nothing excludes or limits liability that cannot lawfully be excluded or limited, including applicable consumer remedies, fraud, fraudulent misrepresentation, gross negligence, or rights arising under data-protection law. A limitation in a merchant agreement does not reduce a student’s statutory rights. There is no automatic financial cap or general indemnity imposed on students by this draft.',
  ] },
