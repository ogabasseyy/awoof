...
No claims have been approved by creating this template. Missing evidence means omit/narrow the claim or label it as planned, never treat the empty register as a passed review. Future PRs must update the register and affected pages or explain why no changes are necessary, as required by AGENTS.md.
