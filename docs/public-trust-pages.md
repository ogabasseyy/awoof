...
| Privacy policy / terms of service | `/privacy`, `/terms` (review drafts only) | `apps/web/src/content/public/legal-drafts.ts`; `docs/legal-policy-review.md`; legal content not approved | Draft only; production still returns 404 | Needs owner/legal | 2026-09-23 | **Blocked: not effective policies or usable for Microsoft consent** |
